            ...
            <div class="px-4 sm:px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    ...
                    <Create v-if="can(['create generic'])" :numberPermissions="props.numberPermissions"
                        :titulos="titulous" :show="data.createOpen" @close="data.createOpen = false" :title="props.title"
                        :losSelect=props.losSelect />

                    <Edit v-if="can(['update generic'])" :titulos="titulous"
                    ...
                    <table v-if="props.total > 0" class="w-full">
                        <thead class="uppercase text-sm border-t border-gray-200 dark:border-gray-700">
                            <tr class="dark:bg-gray-900/50 text-left">
                                ...
                                <th v-for="titulo in titulous" :key="titulo" class="px-2 py-4 cursor-pointer"
                        ...
                        <tbody>
                            <tr v-for="(claseFromController, indexu) in props.fromController.data" :key="indexu"
                                ...
                                <td v-for="titulo in titulous" :key="titulo" class="whitespace-nowrap py-4 px-2 sm:py-3">
